import pitStpBurger from "../assets/pit-stop-burger.png"; 
import turboChargedBadge from "../assets/turbo-charged-delivery.png";
import { Link } from "react-router-dom";

export default function PitStopCareers() {
    return (
        <section className="w-full relative overflow-hidden md:h-[595px] h-[280px] bg-white">
            ...
            <div className="flex items-center justify-end w-full h-full relative px-5 py-12 md:px-10 lg:px-14.5">
                ...
                <div className="flex flex-col md:gap-4 lg:gap-4 gap-3 z-20 max-w-[55%] md:max-w-[50%] lg:max-w-[48%] items-start">

                    {/* Heading - Mix of Host Grotesk Medium and Spatial Black */}
                    <div className="flex flex-col leading-none">
                        <h2 className="font-spatial-black text-white uppercase leading-none text-[30px] md:text-[50px] xl:text-[70px] 2xl:text-[93px] tracking-tighter font-bold" style={{transform:'scaleY(0.9'}}>
                            PIT STOP
                        </h2>
                        <h2 className="font-medium text-white uppercase italic leading-none tracking-tight text-[25px] md:text-[50px] xl:text-[85px] 2xl:text-[100px] font-bold" style={{transform:'scaleY(1.1)'}}>
                            PERFECTION
                        </h2>
                    </div>
